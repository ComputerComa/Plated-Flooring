...
-- Plated floor
  {
    ...
    minable = {mining_time = 0.1, result = "colony-tile-plate"},
...
-- Smooth floor
{
  ...
  order = "a-a-c",--"a-c-d",
  needs_correction = false,
  minable = {mining_time = 0.1, result = "colony-tile-smooth"},
  mined_sound = { filename = "__base__/sound/deconstruct-bricks.ogg",volume = 0.8},
  --collision_mask = tile_collision_masks.ground,
  collision_mask = {layers={ground_tile=true}},
  ...
  variants =
  {
    main =
    {
      { picture = "__base__/graphics/terrain/lab-tiles/lab-dark-1.png", count = 1, size = 1, scale = 0.5 }
    },
